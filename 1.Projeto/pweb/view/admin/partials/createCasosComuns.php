    <!-- Logout Modal-->
    <div class="modal fade" id="createCasosComuns" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Criar um novo Caso Comum:</h5>
                ...
                <div class="modal-body">
                    <p>Preencha os dados abaixo para cadastrar um novo Caso Comum</p>
                        ...
                        <div class="row">
                            <div class="col col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="casocomum" aria-describedby="emailHelp" autocomplete="off" name="casocomum" placeholder="Nome do Caso Comum">
