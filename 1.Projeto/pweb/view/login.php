  ...
  <section class="contact_section layout_padding-bottom">
    ...
    <div class="container">
      <div class="heading_container">
        <h2>
          Faça seu login <?php echo $logado; ?>
        </h2>
      </div>
      ...
      <div class="row">
        <div class="col-md-7">
          ...
          <div class="form_container">
            ...
            <form action="../index.php?classe=Profissional&acao=authenticateProfissional" target="_blank" method="POST">
               <div>
                <input type="text" name="cpf" placeholder="CPF" id="cpf" required autocomplete="off" />
              </div>
